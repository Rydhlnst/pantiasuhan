  ...
  return (
    <>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-4xl mx-auto mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-4 max-w-2xl mx-auto mb-8">
            <div className="bg-blue-50 border border-blue-200 rounded-none p-4 text-left">
              <h3 className="font-semibold text-blue-800 mb-2">Layanan Kami:</h3>
